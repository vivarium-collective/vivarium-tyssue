...
# Stem cell
rates_max['sc']['sc'] = 0.15/100  # 0.09
rates_max['sc']['pc'] = 0.2/100 # 0.04

# Progenitor cell
rates_max['pc']['pc'] = 0.22/100
rates_max['pc']['ent'] = 0.25/100  # 0.15
rates_max['pc']['gc'] = rates_max['pc']['ent'] * 0.33

# Goblet cell
rates_max['gc']['ex'] = 0.34/100  # 0.4

# Enterocyte
rates_max['ent']['ex'] = 0.34/100  # 0.4
